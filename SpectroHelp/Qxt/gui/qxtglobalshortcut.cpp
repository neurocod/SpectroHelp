...
QAbstractNativeEventFilter* QxtGlobalShortcutPrivate::prevEventFilter = 0;
#endif // Q_WS_MAC
...
QxtGlobalShortcutPrivate::QxtGlobalShortcutPrivate() : enabled(true), key(Qt::Key(0)), mods(Qt::NoModifier)
{
    ...
    //if (!ref++)
        //prevEventFilter = QAbstractEventDispatcher::instance()->installNativeEventFilter(eventFilter());
#endif // Q_WS_MAC
}
